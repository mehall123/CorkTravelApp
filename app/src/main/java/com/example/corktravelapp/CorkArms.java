...
public class CorkArms extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cork_arms);
    }
    ...
    public void Open_email(View view){
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                emailIntent.setData(Uri.parse("mailto:info@corkarms.ie"));
    ...
    public void Open_maps(View view){
        ...
        buttonMap.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=51.909881881197556, -8.469772821552132");
