...
public class LibertyGrill extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_liberty_grill);
    }
    ...
    public void Open_email(View view){
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                emailIntent.setData(Uri.parse("mailto:info@libertygrills.ie"));
    ...
    public void Open_maps(View view){
        ...
        buttonMap.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=51.9056457636504, -8.48030630016194");
