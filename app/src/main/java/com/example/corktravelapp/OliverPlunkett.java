...
public class OliverPlunkett extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oliver_plunkett);
    }
    ...
    public void Open_email(View view){
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                emailIntent.setData(Uri.parse("mailto:info@theoliverplunkett.com"));
    ...
    public void Open_maps(View view){
        ...
        buttonMap.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=51.89922369475223, -8.46972893471478");
